...
#define MagickSVNRevision  "12978M"
...
#define MagickDelegates "bzlib djvu fftw fitz fontconfig freetype jng jp2 jpeg lcms lzma openexr pango png ps tiff webp x xml zlib"
