...
#define MagickReleaseDate  "2013-03-29"
#define MagickChangeDate   "20130329"
#define MagickFeatures "DPC OpenMP"
#define MagickDelegates "bzlib fontconfig freetype jng jpeg lcms lzma pango png ps tiff x xml zlib"
