...
static const OptionInfo
  ...
  InterpolateOptions[] =
  {
    ...
    { "NearestAverage", NearestAverageInterpolatePixel, UndefinedOptionFlag, MagickFalse },
    { "NearestBackground", NearestBackgroundInterpolatePixel, UndefinedOptionFlag, MagickFalse },
    { "NearestBlend", NearestBlendInterpolatePixel, UndefinedOptionFlag, MagickFalse },
