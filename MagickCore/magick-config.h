...
/*  ABI SUFFIX */
#ifndef HDRI_SUPPORT
#define MAGICKCORE_ABISUFFIX  "Q" MAGICKCORE_STRING_XQUOTE(MAGICKCORE_QUANTUM_DEPTH)
#else 
#define MAGICKCORE_ABISUFFIX "QHDRI" MAGICKCORE_STRING_XQUOTE(MAGICKCORE_QUANTUM_DEPTH)
#endif 
...
# define MAGICKCORE_MODULES_DIRNAME MAGICKCORE_MODULES_BASEDIRNAME "-" MAGICKCORE_ABISUFFIX
#endif
