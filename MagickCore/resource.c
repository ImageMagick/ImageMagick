  ...
  const MagickSizeType size)
{
  ...
  switch (type)
  {
    ...
    case DiskResource:
    {
      ...
      if (((MagickOffsetType) resource_info.disk+request) > resource_info.disk)
        {
    ...
    case FileResource:
    {
      ...
      if (((MagickOffsetType) resource_info.file+request) > resource_info.file)
        {
    ...
    case MapResource:
    {
      ...
      if (((MagickOffsetType) resource_info.map+request) > resource_info.map)
        {
    ...
    case MemoryResource:
    {
      ...
      if (((MagickOffsetType) resource_info.memory+request) > resource_info.memory)
        {
    ...
    case TimeResource:
    {
      ...
      if (((MagickOffsetType) resource_info.time+request) > resource_info.time)
        {
