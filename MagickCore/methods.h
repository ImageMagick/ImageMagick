...
#define PendInitializePixelChannelMap  PrependMagickMethod(PendInitializePixelChannelMap)
...
#define SetPixelChannelMap  PrependMagickMethod(SetPixelChannelMap)
