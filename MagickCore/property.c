 ...
 \
  ...
  static const TagInfo
    EXIFTag[] =
    {
      ...
      {  0x8825, "exif:gps:Info" }, /* specs as "GPSInfo IFD Pointer"? */
      ...
      { 0x10000, "exif:gps:VersionID" },
      { 0x10001, "exif:gps:LatitudeRef" },
      { 0x10002, "exif:gps:Latitude" },
      { 0x10003, "exif:gps:LongitudeRef" },
      { 0x10004, "exif:gps:Longitude" },
      { 0x10005, "exif:gps:AltitudeRef" },
      { 0x10006, "exif:gps:Altitude" },
      { 0x10007, "exif:gps:TimeStamp" },
      { 0x10008, "exif:gps:Satellites" },
      { 0x10009, "exif:gps:Status" },
      { 0x1000a, "exif:gps:MeasureMode" },
      { 0x1000b, "exif:gps:Dop" },
      { 0x1000c, "exif:gps:SpeedRef" },
      { 0x1000d, "exif:gps:Speed" },
      { 0x1000e, "exif:gps:TrackRef" },
      { 0x1000f, "exif:gps:Track" },
      { 0x10010, "exif:gps:ImgDirectionRef" },
      { 0x10011, "exif:gps:ImgDirection" },
      { 0x10012, "exif:gps:MapDatum" },
      { 0x10013, "exif:gps:DestLatitudeRef" },
      { 0x10014, "exif:gps:DestLatitude" },
      { 0x10015, "exif:gps:DestLongitudeRef" },
      { 0x10016, "exif:gps:DestLongitude" },
      { 0x10017, "exif:gps:DestBearingRef" },
      { 0x10018, "exif:gps:DestBearing" },
      { 0x10019, "exif:gps:DestDistanceRef" },
      { 0x1001a, "exif:gps:DestDistance" },
      { 0x1001b, "exif:gps:ProcessingMethod" },
      { 0x1001c, "exif:gps:AreaInformation" },
      { 0x1001d, "exif:gps:DateStamp" },
      { 0x1001e, "exif:gps:Differential" },
      { 0x1001f, "exif:gps:HPositioningError" },
      { 0x00000, "" }
