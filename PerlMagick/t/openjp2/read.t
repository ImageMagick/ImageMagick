...
testReadCompare('input.jp2', '../reference/jp2/read_jp2.miff', q//, 0.0, 0.0);
...
++$test;
print( " ...\n" );
testReadCompare('input.jpc', '../reference/jp2/read_jpc.miff', q//, 0.0, 0.0);
...
++$test;
print( " ...\n" );
testReadCompare('input.pgx', '../reference/jp2/read_pgx.miff', q//, 0.0, 0.0);
