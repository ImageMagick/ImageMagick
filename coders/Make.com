...
$  compile_options="/nodebug/optimize/prefix=all/warning=(disable=rightshiftovr)/name=(as_is,short)/float=ieee/list/show=all"
$endif
$
$
...
$deass magick
$deass wand
$library/create libCoders.olb art,avs,bmp,clip,clipboard,cip,cmyk,cut,dcm, -
  dib,dng,dps,dpx,emf,ept,exr,fax,fits,fpx,gif,gradient,gray,histogram,html, -
  icon,info,jbig,jpeg,jp2,label,caption,palm,map,mat,matte,meta,miff,mpc, -
  mpr,msl,mpeg,mono,mtv,mvg,null,otb,pattern,pcd,pcl,pcx,pdb,pdf,pict,pix, -
	plasma,png,pnm,preview,ps,ps2,ps3,psd,pwp,raw,rgb,rla,rle,sct,sfw,sgi, -
	stegano,sun,svg,tga,thumbnail,tiff,tile,tim,ttf,txt,uil,url,uyvy,vicar,vid, -
   viff,wbmp,wmf,wpg,x,xbm,xc,xcf,xpm,xps,xwd,ycbcr,yuv,cin,magick,scr,ipl, -
   aai,cals,dds,debug,hald,hdr,hrz,inline,mac,pes,braille,mask,screenshot, -
   vips,fd,json,pango,bgr,jnx,rgf,sixel, -
	[-.magick]compress
$exit
$
$Make: subroutine
