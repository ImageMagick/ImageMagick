...
PACKAGE_VERSION='6.8.6'
PACKAGE_PERL_VERSION='6.86'
PACKAGE_LIB_VERSION="0x686"
PACKAGE_RELEASE="10"
PACKAGE_LIB_VERSION_NUMBER="6,8,6,${PACKAGE_RELEASE}"
...
PACKAGE_VERSION_ADDENDUM="-${PACKAGE_RELEASE}~beta`date`"
